...
class _GroceryDetailsPageState extends State<GroceryDetailsPage> {
  ...
  Future<void> fetchProducts() async {
    ...
    final response = await http.get(
      Uri.parse(
          'https://moodpandaa.com/public/api/grocery/${widget.userId}/products?page=$page'),
    );
    ...
    if (response.statusCode == 200) {
      ...
      // Debugging line: Print the first product's details
      print(newProducts[0]); // This will print the entire product data
      ...
      if (existingIndex != -1) {
        ...
        widget.sharedCart.add({
          ...
          'category_id': product['category_id'] ??
              'Not Available', // Add category_id to cart with fallback
        });
      }
    });
  }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Category Id: ${product['category_id'] ?? 'Not Available'}',
                  style: TextStyle(fontStyle: FontStyle.italic),
                ),
                Text(
                  'Platform Id: ${product['platform_id'] ?? 'Not Available'}',
                  style: TextStyle(fontStyle: FontStyle.italic),
                ),
              ],
            ),
