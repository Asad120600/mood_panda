...
class RiderProfilePage extends StatefulWidget {
  ...
  RiderProfilePage({Key? key, required this.userName}) : super(key: key);
...
class _RiderProfilePageState extends State<RiderProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Rider Profile Page')),
      drawer: CustomDrawer(
        onItemSelected: (String value) {
          switch (value) {
            case 'RiderProfile':
              Navigator.pushNamed(context, '/riderprofile', arguments: widget.userName);
              break;
            case 'ConfirmOrder':
              Navigator.pushNamed(context, '', arguments: widget.userName);
              break;
            case 'Dashboard':
              Navigator.pushNamed(context, '/riderPage', arguments: widget.userName);
              break;
            case 'RejectOrder':
              Navigator.pushNamed(context, '/', arguments: widget.userName);
              break;
