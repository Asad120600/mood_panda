...
class RecivingPayment extends StatefulWidget {
  // final String userName;
  const RecivingPayment({super.key});
  // PendingPayment({Key? key, required this.userName}) : super(key: key);

  @override
  State<RecivingPayment> createState() => _RecivingPaymentState();
}

class _RecivingPaymentState extends State<RecivingPayment> {
